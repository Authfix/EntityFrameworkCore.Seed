...
namespace Authfix.EntityFrameworkCore.Seed.Script.Internal
{
    internal partial class SeedAssembly : ISeedAssembly
    {
        ...
        /// <returns></returns>
        public IEnumerable<SeedInfo> GetAvailableSeeds(string dbContextType)
        {
            var availableSeeds = new Dictionary<Type, SeedInfo>();
            ...
            foreach (var type in Assembly.DefinedTypes)
            {
                ...
                var seederAttributeInfo = new SeedInfo(type, seederAttribute);
